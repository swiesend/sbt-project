...
object Application extends App {
  ...
  // Or load a configuration from another file:
  val myConf = ConfigFactory.parseFile(new File("conf/application.conf")).resolve()
  ...
  try {
    // Access your database from within the try and
  ...
  // You can also log independently from your actors and can reuse the 
  // same configuration.
